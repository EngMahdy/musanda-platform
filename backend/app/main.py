...
FRONTEND_DIR_STR = os.getenv(
    "FRONTEND_DIR", 
    str(Path(__file__).parent.parent.parent / "frontend" / "public")
)
FRONTEND_DIR = Path(FRONTEND_DIR_STR)


# ===== Initialize Database IMMEDIATELY (before routers) =====
try:
...
print(f"🚀 Musanada 2.0 ready! Environment: {ENVIRONMENT}")
